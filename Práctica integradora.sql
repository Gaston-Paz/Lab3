...
-- 10- Por cada tipo de tarea listar el nombre, el precio de hora base y el promedio de valor hora real (obtenido de las colaboraciones). También, una columna llamada Variación con las siguientes reglas:
